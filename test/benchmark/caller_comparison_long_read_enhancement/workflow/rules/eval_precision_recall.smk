...
rule cat_truvari_pr_rec_results_all:
    input:
        ...
        pr_SL2x3   = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/SL2x3/min_qual_{min_qual}/pr.txt",
                            min_qual = min_qual_iGenVar),
        pr_SL2x5   = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/SL2x5/min_qual_{min_qual}/pr.txt",
                            min_qual = min_qual_iGenVar),
        pr_SL2x10   = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/SL2x10/min_qual_{min_qual}/pr.txt",
                            min_qual = min_qual_iGenVar),
        ...
        pr_L2x3    = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/L2x3/min_qual_{min_qual}/pr.txt",
                            min_qual = min_qual_iGenVar),
        pr_L2x5    = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/L2x5/min_qual_{min_qual}/pr.txt",
                            min_qual = min_qual_iGenVar),
        pr_L2x10   = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/L2x10/min_qual_{min_qual}/pr.txt",
                            min_qual = min_qual_iGenVar),
        pr_SL2     = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/full_enhancement/min_qual_{min_qual}/pr.txt",
                            min_qual = min_qual_iGenVar),
        ...
        rec_SL2x3  = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/SL2x3/min_qual_{min_qual}/rec.txt",
                            min_qual = min_qual_iGenVar),
        rec_SL2x5  = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/SL2x5/min_qual_{min_qual}/rec.txt",
                            min_qual = min_qual_iGenVar),
        rec_SL2x10 = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/SL2x10/min_qual_{min_qual}/rec.txt",
                            min_qual = min_qual_iGenVar),
        ...
        rec_L2x3   = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/L2x3/min_qual_{min_qual}/rec.txt",
                            min_qual = min_qual_iGenVar),
        rec_L2x5   = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/L2x5/min_qual_{min_qual}/rec.txt",
                            min_qual = min_qual_iGenVar),
        rec_L2x10  = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/L2x10/min_qual_{min_qual}/rec.txt",
                            min_qual = min_qual_iGenVar),
        rec_SL2    = expand("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/full_enhancement/min_qual_{min_qual}/rec.txt",
                            min_qual = min_qual_iGenVar),
    ...
    output:
        ...
        pr_SL2x5    = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/pr_SL2x5.all_results.txt"),
        pr_SL2x10   = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/pr_SL2x10.all_results.txt"),
        ...
        pr_L2x5     = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/pr_L2x5.all_results.txt"),
        pr_L2x10    = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/pr_L2x10.all_results.txt"),
        pr_SL2      = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/pr_SL2.all_results.txt"),
        ...
        rec_SL2x5   = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/rec_SL2x5.all_results.txt"),
        rec_SL2x10  = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/rec_SL2x10.all_results.txt"),
        ...
        rec_L2x5    = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/rec_L2x5.all_results.txt"),
        rec_L2x10   = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/rec_L2x10.all_results.txt"),
        rec_SL2     = temp("results/caller_comparison_long_read_enhancement/{{dataset}}/eval/rec_SL2.all_results.txt"),
    ...
    run:
        ...
        shell("cat {input.pr_SL2x5} > {output.pr_SL2x5}")
        shell("cat {input.pr_SL2x10} > {output.pr_SL2x10}")
        shell("cat {input.pr_L2x1} > {output.pr_L2x1}")
        shell("cat {input.pr_L2x2} > {output.pr_L2x2}")
        shell("cat {input.pr_L2x3} > {output.pr_L2x3}")
        shell("cat {input.pr_L2x5} > {output.pr_L2x5}")
        shell("cat {input.pr_L2x10} > {output.pr_L2x10}")
        shell("cat {input.pr_SL2} > {output.pr_SL2}")
        shell("cat {input.pr_L2} > {output.pr_L2}")
        shell("""
            cat {output.pr_S} {output.pr_SL2x1} {output.pr_SL2x2} {output.pr_SL2x3} {output.pr_SL2x5} {output.pr_SL2x10} \
                {output.pr_L2x1} {output.pr_L2x2} {output.pr_L2x3} {output.pr_L2x5} {output.pr_L2x10} \
                {output.pr_SL2} {output.pr_L2} > {output.pr_all}
        """)
        ...
        shell("cat {input.rec_SL2x5} > {output.rec_SL2x5}")
        shell("cat {input.rec_SL2x10} > {output.rec_SL2x10}")
        shell("cat {input.rec_L2x1} > {output.rec_L2x1}")
        shell("cat {input.rec_L2x2} > {output.rec_L2x2}")
        shell("cat {input.rec_L2x3} > {output.rec_L2x3}")
        shell("cat {input.rec_L2x5} > {output.rec_L2x5}")
        shell("cat {input.rec_L2x10} > {output.rec_L2x10}")
        shell("cat {input.rec_SL2} > {output.rec_SL2}")
        shell("cat {input.rec_L2} > {output.rec_L2}")
        shell("""
            cat {output.rec_S} {output.rec_SL2x1} {output.rec_SL2x2} {output.rec_SL2x3} {output.rec_SL2x5} {output.rec_SL2x10} \
                {output.rec_L2x1} {output.rec_L2x2} {output.rec_L2x3} {output.rec_L2x5} {output.rec_L2x10} \
                {output.rec_SL2} {output.rec_L2} > {output.rec_all}
        """)
