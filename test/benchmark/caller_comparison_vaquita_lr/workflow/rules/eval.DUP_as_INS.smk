...
rule DUP_as_INS_filter_vcf:
    ...
    log:
        "logs/caller_comparison_vaquita_lr/filter_vcf_output.{input_combination}.DUP_as_INS.{min_qual}.log",
    conda:
        "../../../envs/bcftools.yaml"
    shell:
...
rule DUP_as_INS_cat_truvari_results_all:
    input:
        ...
        S1L1 = expand("results/caller_comparison_vaquita_lr/eval/S1L1/DUP_as_INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual=list(range(config["quality_ranges"]["from"],
                                          config["quality_ranges"]["to"],
                                          config["quality_ranges"]["step"]))),
        S2L1 = expand("results/caller_comparison_vaquita_lr/eval/S2L1/DUP_as_INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual=list(range(config["quality_ranges"]["from"],
                                          config["quality_ranges"]["to"],
                                          config["quality_ranges"]["step"]))),
        S1L2 = expand("results/caller_comparison_vaquita_lr/eval/S1L2/DUP_as_INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual=list(range(config["quality_ranges"]["from"],
                                          config["quality_ranges"]["to"],
                                          config["quality_ranges"]["step"]))),
        S2L2 = expand("results/caller_comparison_vaquita_lr/eval/S2L2/DUP_as_INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual=list(range(config["quality_ranges"]["from"],
                                          config["quality_ranges"]["to"],
                                          config["quality_ranges"]["step"]))),
        S1L3 = expand("results/caller_comparison_vaquita_lr/eval/S1L3/DUP_as_INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual=list(range(config["quality_ranges"]["from"],
                                          config["quality_ranges"]["to"],
                                          config["quality_ranges"]["step"]))),
    ...
    output:
        ...
        S2L1 = temp("results/caller_comparison_vaquita_lr/eval/S2L1.DUP_as_INS.all_results.txt"),
        S1L2 = temp("results/caller_comparison_vaquita_lr/eval/S1L2.DUP_as_INS.all_results.txt"),
        S2L2 = temp("results/caller_comparison_vaquita_lr/eval/S2L2.DUP_as_INS.all_results.txt"),
        S1L3 = temp("results/caller_comparison_vaquita_lr/eval/S1L3.DUP_as_INS.all_results.txt"),
