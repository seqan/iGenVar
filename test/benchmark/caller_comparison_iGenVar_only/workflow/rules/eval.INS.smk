...
rule cat_truvari_results_INS:
    input:
        ...
        S2   = expand("results/caller_comparison_iGenVar_only/eval/S2/INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual = min_qual_iGenVar),
        S1L1 = expand("results/caller_comparison_iGenVar_only/eval/S1L1/INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual = min_qual_iGenVar),
        S2L1 = expand("results/caller_comparison_iGenVar_only/eval/S2L1/INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual = min_qual_iGenVar),
        S1L2 = expand("results/caller_comparison_iGenVar_only/eval/S1L2/INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual = min_qual_iGenVar),
        S2L2 = expand("results/caller_comparison_iGenVar_only/eval/S2L2/INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual = min_qual_iGenVar),
        S1L3 = expand("results/caller_comparison_iGenVar_only/eval/S1L3/INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual = min_qual_iGenVar),
        S2L3 = expand("results/caller_comparison_iGenVar_only/eval/S2L3/INS.min_qual_{min_qual}/pr_rec.txt",
                      min_qual = min_qual_iGenVar),
    ...
    output:
        ...
        S1L1 = temp("results/caller_comparison_iGenVar_only/eval/S1L1.INS_results.txt"),
        S2L1 = temp("results/caller_comparison_iGenVar_only/eval/S2L1.INS_results.txt"),
        S1L2 = temp("results/caller_comparison_iGenVar_only/eval/S1L2.INS_results.txt"),
        S2L2 = temp("results/caller_comparison_iGenVar_only/eval/S2L2.INS_results.txt"),
        S1L3 = temp("results/caller_comparison_iGenVar_only/eval/S1L3.INS_results.txt"),
        S2L3 = temp("results/caller_comparison_iGenVar_only/eval/S2L3.INS_results.txt"),
