...
rule simulation_truvari:
    ...
    params:
        output_dir = "results/caller_comparison_iGenVar_only/eval/{input_combination}/simulation.min_qual_{min_qual}"
    output:
        summary = "results/caller_comparison_iGenVar_only/eval/{input_combination}/simulation.min_qual_{min_qual}/summary.txt"
    log:
...
rule simulation_reformat_truvari_results:
    input:
        "results/caller_comparison_iGenVar_only/eval/{input_combination}/simulation.min_qual_{min_qual}/summary.txt"
    output:
        "results/caller_comparison_iGenVar_only/eval/{input_combination}/simulation.min_qual_{min_qual}/pr_rec.txt"
    threads: 1
    shell:
        """
...
rule simulation_cat_truvari_results_all:
    input:
        hg38_Sim_default  = expand("results/caller_comparison_iGenVar_only/eval/hg38_Sim_default/simulation.min_qual_{min_qual}/pr_rec.txt",
                                   min_qual = min_qual_iGenVar),
        hg38_Sim_InDel    = expand("results/caller_comparison_iGenVar_only/eval/hg38_Sim_InDel/simulation.min_qual_{min_qual}/pr_rec.txt",
                                   min_qual = min_qual_iGenVar),
        hg38_Sim_noSNP    = expand("results/caller_comparison_iGenVar_only/eval/hg38_Sim_noSNP/simulation.min_qual_{min_qual}/pr_rec.txt",
                                   min_qual = min_qual_iGenVar),
        hg38_Sim_SNPandSV = expand("results/caller_comparison_iGenVar_only/eval/hg38_Sim_SNPandSV/simulation.min_qual_{min_qual}/pr_rec.txt",
                                   min_qual = min_qual_iGenVar)
    output:
        hg38_Sim_default  = temp("results/caller_comparison_iGenVar_only/eval/hg38_Sim_default.all_results.txt"),
        hg38_Sim_InDel    = temp("results/caller_comparison_iGenVar_only/eval/hg38_Sim_InDel.all_results.txt"),
        hg38_Sim_noSNP    = temp("results/caller_comparison_iGenVar_only/eval/hg38_Sim_noSNP.all_results.txt"),
        hg38_Sim_SNPandSV = temp("results/caller_comparison_iGenVar_only/eval/hg38_Sim_SNPandSV.all_results.txt"),
        all = "results/caller_comparison_iGenVar_only/eval/simulation.txt"
    threads: 1
    run:
