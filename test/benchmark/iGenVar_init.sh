...
echo "$(tput setaf 1)$(tput setab 7)------- iGenVar downloaded (1/6) --------$(tput sgr 0)" 1>&3
...
echo "$(tput setaf 1)$(tput setab 7)------- iGenVar built (2/6) --------$(tput sgr 0)" 1>&3
...
echo "$(tput setaf 1)$(tput setab 7)------- short reads downloaded (3/6) --------$(tput sgr 0)" 1>&3
...
cd ..
echo "$(tput setaf 1)$(tput setab 7)------- long reads downloaded (4/6) --------$(tput sgr 0)" 1>&3
...
cd ..
echo "$(tput setaf 1)$(tput setab 7)------- reference downloaded (5/6) --------$(tput sgr 0)" 1>&3
...
cd ../..
echo "$(tput setaf 1)$(tput setab 7)------- truth set downloaded (7/6) --------$(tput sgr 0)" 1>&3
